...
const COMPONENT_ATTRIBUTE_NAME = 'component';
...
export class Component {
    ...
    static getComponentByElement (element) {
        ...
        const componentName = element.getAttribute(COMPONENT_ATTRIBUTE_NAME);
    ...
    static init () {
        if (!initPromise) {
            let elements = document.querySelectorAll(`[${COMPONENT_ATTRIBUTE_NAME}]`);
            let promises = new Array;

            Array.prototype.forEach.call(elements, function (element, index, list) {
                let component = Component.getComponentByElement();
